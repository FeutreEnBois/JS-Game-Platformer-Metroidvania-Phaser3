...
class Preloader extends Phaser.Scene {
    ...
    create() {
        ...
        this.anims.create({ key: 'goblin_walk', frames: this.anims.generateFrameNumbers('goblin', {start:0, end: 3}), repeat: -1, frameRate: 10});
        this.anims.create({ key: 'goblin_idle', frames: this.anims.generateFrameNumbers('goblin', {start:4, end: 7}), repeat: -1, frameRate: 10});
        this.anims.create({
            key: 'left',
